    ...
    <div className="container mx-auto py-12 px-4 md:px-6 flex-1 bg-gray-50">
      <div className="text-center mb-10">
        <div className="flex justify-center items-center mb-4">
          <Image src="https://i.imgur.com/83u1T1v.png" alt="Worldwide Express Logo" width={200} height={50} />
        </div>
      ...
      <Card className="max-w-4xl mx-auto shadow-lg">
        <CardHeader>
           <p className="text-center text-sm text-muted-foreground pt-6">This Agreement is made and entered into on {currentDate}, by and between: Worldwide Express LLC</p>
        </CardHeader>
